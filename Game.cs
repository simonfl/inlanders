...
public partial class Game : Node3D
{
    ...
    public override void _Process(double delta)
    {
        ...
        if (!EditingText && !_catalogKeyboard && !_peopleKeyboard && !_economyKeyboard && !_goalsKeyboard && pan != Vector3.Zero) { _watchOrbit=false; _followPerson = false; _focus += pan.Rotated(Vector3.Up, _angle) * dt * Math.Max(7, _camera.Size * 0.35f); UpdateCamera(); }
