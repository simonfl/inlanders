...
if(args.Contains("--livelihood-site")){try{LivelihoodSiteChecks.Run();}catch(Exception e){Console.Error.WriteLine(e);Environment.ExitCode=1;}return;}
if(args.Contains("--player-founded")){try{PlayerFoundedChecks.Run();}catch(Exception e){Console.Error.WriteLine(e);Environment.ExitCode=1;}return;}
if(args.Contains("--grain-relocation")){try{GrainRelocationChecks.Run();}catch(Exception e){Console.Error.WriteLine(e);Environment.ExitCode=1;}return;}
if(args.Contains("--oven-workyard")){try{OvenWorkyardChecks.Run();}catch(Exception e){Console.Error.WriteLine(e);Environment.ExitCode=1;}return;}
...
if(args.Contains("--vegetable-field")){try{VegetableFieldChecks.Run();}catch(Exception e){Console.Error.WriteLine(e);Environment.ExitCode=1;}return;}
...
if(args.Contains("--food-livelihood-growth")){try{FoodLivelihoodChecks.Run("grain-grow");}catch(Exception e){Console.Error.WriteLine(e);Environment.ExitCode=1;}return;}
if(args.Contains("--batch-bread")){try{BatchBreadChecks.Run();}catch(Exception e){Console.Error.WriteLine(e);Environment.ExitCode=1;}return;}
if(args.Contains("--food-livelihood")){try{FoodLivelihoodChecks.Run();}catch(Exception e){Console.Error.WriteLine(e);Environment.ExitCode=1;}return;}
...
if(args.Contains("--route-perf")){try{RoutePerformanceChecks.Run(args);}catch(Exception e){Console.Error.WriteLine(e);Environment.ExitCode=1;}return;}
...
if(args.Contains("--redevelopment-recovery")) {try{RedevelopmentChecks.Recovery();}catch(Exception e){Console.Error.WriteLine(e);Environment.ExitCode=1;}return;}
if(args.Contains("--redevelopment")) {try{RedevelopmentChecks.Run();}catch(Exception e){Console.Error.WriteLine(e);Environment.ExitCode=1;}return;}
