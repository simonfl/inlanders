...
public partial class Game
{
    ...
    {
        CancelAreaRemoval();CancelBushMove();
    ...
    private void CloseManagementUi() { CancelAreaRemoval();CancelBushMove();CancelRelocation(false);StopGoalsKeyboard();StopEconomyKeyboard();_economyFocusKey="survey";_economyReturnKey="survey";StopPeopleKeyboard();_peopleLastPerson=0; if (_viewName != null) { _viewName.Text = ""; _viewName.ReleaseFocus(); }
