...
public partial class Game
{
    ...
    private void CloseManagementUi() { StopGoalsKeyboard();StopEconomyKeyboard();_economyFocusKey="survey";_economyReturnKey="survey";StopPeopleKeyboard();_peopleLastPerson=0; if (_viewName != null) { _viewName.Text = ""; _viewName.ReleaseFocus(); }
