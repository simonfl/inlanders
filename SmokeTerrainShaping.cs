...
public partial class Game
{
    private async Task CheckTerrainShapingUi()
    {
        ...
        foreach(int width in new[]{960,1440})
        {
            ...
            Check(w.SaveJson()==blocked && _terrainApply.Disabled,"Stale Apply changed terrain");await Capture($"artifacts/terrain-shaping/blocked-{width}.png");
            ...
            var cottage=w.Place(at,0);Check(cottage!=null,"Cannot build on actual terrace");w.RemoveBuilding(cottage!.Id);
