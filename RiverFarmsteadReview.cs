...
public partial class Game
{
    private async Task ProbeRiverFarmstead()
    {
        ...
        ShowMainMenu();await Frames();await UiClick(_mainButtons["Earlier prototypes"]);await Frames();await UiClick(_mainButtons["Earlier farmstead"]);await Frames();await CaptureReviewBundle("farmstead-menu");
