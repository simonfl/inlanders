...
## Campaign: five introductions, Across the river and Life by the lake
...
7. **Life by the lake:** deliver four fish, then use Goals to prepare expansion to twelve. House everyone; three quarters need home rest within four minutes, and half need a square visit within two minutes. Start assessment when ready: three consecutive full mixed meals with fresh deliveries covering consumption, while maintaining those living standards. Food can come from any mix of producers. Missed conditions explain what to improve and restart the short proof.
