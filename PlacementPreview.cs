...
public partial class Game
{
    ...
    private string OrdinaryBuildingDescription(BuildingKind kind) => kind switch
    {
        ...
        BuildingKind.FishingDock => "One fisher and boat. Needs three dry shore tiles, a clear water launch and reachable fishing grounds. Stocks replenish over time. " + (_world.HasWorkplaceFood ? "Catches are stored at the dock for collection." : "Catches return to food storage."),
    ...
    private bool PointerOverHud(Vector2 point) => _watching ? (_watchBar.Visible && _watchBar.GetGlobalRect().HasPoint(point)) :
        ...
        (_gatherPlanPanel!=null && _gatherPlanPanel.Visible && _gatherPlanPanel.GetGlobalRect().HasPoint(point)) ||
