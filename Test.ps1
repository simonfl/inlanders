param([switch]$Rendered, [switch]$Balance, [switch]$ComfortComparison)
...
if ($ComfortComparison) { & "$env:DOTNET_ROOT\dotnet.exe" run --project Tests/SimulationTests.csproj -- --comfort-comparison }
