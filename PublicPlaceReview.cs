...
public partial class Game
{
    private async Task ProbePublicPlaceContract()
    {
        ...
        {
            var profile=new Inlanders.Simulation.HamletProfile(relaxed,_world.Founding!.CultivatedBank,_world.Founding.GroupedFarmsteads,_world.Founding.AcrossTheInlet);
