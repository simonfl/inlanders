...
public partial class Game
{
    ...
    private static Role? WorkplaceRole(BuildingKind kind) => kind switch
    {
        ...
        BuildingKind.HuntingLodge => Role.Hunter, BuildingKind.Quarry => Role.Quarrier, BuildingKind.ForagerHut => Role.Forager, BuildingKind.Farm or BuildingKind.VegetableField or BuildingKind.VegetableGarden or BuildingKind.Orchard => Role.Farmer,
    ...
    private void MakeManagementControls()
    {
        ...
        MakeWelcomeControls();MakeGatheringControls();
    ...
    private void UpdateManagementControls()
    {
        ...
        UpdateWelcomeControls();UpdateGatheringControls();
