...
| 4 | F26a | **Life by the lake.** One fishing dock/boat, connected water habitat and delivered fish, paired with an authored campaign settlement. | Shore choice, shared replenishing fish stocks and worker time create a useful alternative to cultivation. Boats visibly leave, return and unload; several food mixes work. |
