...
| 1 | F03b2 | **Work handoffs and contact.** F03b1 logging has shipped. Next review deliveries, hammer contact and field/harvest motions at the ordinary camera. Tie poses to actual work/cargo, without slowing production for presentation. | Readable pickup/drop and tool use, with correct cargo and poses across pause, reassignment, demolition and reload. See the work-animation plan. |
