...
**Next: one place worth changing**, selected by [whole-game review60](REVIEW_CHECKPOINT_60.md). Adopt finite, self-directed transformations as the working product hypothesis. The hamlet supports consequential rearrangement, but scripted viable layouts do not establish a personally desirable change or a sustained campaign. Keep productive kitchen gardens as a legitimate choice; a commons is not the prescribed superior result.
