...
**Next: F26c — woodland wildlife prototype.** [Service coverage](SERVICE_COVERAGE_F21I.md) now helps inspect existing rest and recreation. Next test whether retained mature woodland offers a worthwhile food alternative to clearing and cultivation: shared habitat, hunting lodge, visible animals and game delivered into meals. Keep the prototype separate from its campaign scenario.
...
| Review | F26b1 / F25c hall | **Quarry and hall implemented.** Finite shared outcrops, physical stone and mixed-material recovery; hall visits are longer but less frequent than square breaks. | Review construction value and legibility in actual play. Working fixtures reduce recreation travel, but do not establish a food-output gain or construction payback. Small recreation gardens remain unimplemented. |
| 1 | F26c | **Woodland wildlife prototype.** Shared habitat supported by mature woodland, a hunting lodge, visible animals and actual game deliveries into meals. Clearing competes with a renewable food source. | Compare preserved habitat with mixed hunting/cultivation. Overhunting recovers through reduced hunting; tree loss recovers through regrowth. Preview habitat loss and show source stock/access. No ecosystem simulation, leather chain or new campaign yet. |
...
- **F25c — Recreation alternatives, partial:** the gathering hall now complements squares; small garden seating remains a candidate. Compare actual service/time and land use before adding another venue.
...
| F07 — Storage and hauling | Compact yard visuals for large reserves (Creative clearing can produce tall stacks), neighborhood food service (F07c), resource filters, delivery priorities, capacities, broader logistics controls, and relocation. Normal-play demolition shipped in F16b; retain its physical goods recovery. |
...
Orchards and hidden discoveries remain candidates. A neighborhood pantry/market stays with F07c; carpenter/home improvements and limited rest visits are described in F25. Fishing, stone and woodland wildlife have moved into the F26 campaign plan. Trade, broader household routines and procedural maps remain possibilities without a commitment. Infinite terrain or purchased land is not required for map expansion.
