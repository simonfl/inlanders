...
**Next: F26b1 + F25c — quarry and gathering-hall prototype.** F03b1–3 and F04b now cover work contact, crop-specific harvesting, outward home rests and quiet paired square visits; see the [work-animation review](WORK_ANIMATION_F03B.md). [Managed woodland](MANAGED_WOODLAND_F02B.md) and [local plank logistics](LOGISTICS_F07B.md) have also shipped. **F23a still awaits aesthetic feedback**, and **river/lake human pacing remains unverified**; inspect the linked reviews below before expanding the building family or multiplying longer scenarios. The [campaign systems plan](CAMPAIGN_SYSTEMS.md) keeps quarry/hall, wildlife and later resident ambitions scoped as separate future chunks.
...
| 1 | F26b1 / F25c | **Stone into a used gathering hall.** Prototype finite outcrops, a quarry, physical stone transport, mixed-material construction and a distinct attended hall. Compare its cost, space and service against distributed squares on a small resource map. | Placement shows deposits/access before investment; stone reaches a worthwhile consumer; depletion and demolition are recoverable; the hall earns its place without making squares obsolete. Include UI, actual visits and normal-camera review. Exact balance TBD; no new need meter or mandatory stonecutter. |
...
**Next new campaign-system recommendation: F26b + F25c, quarry and gathering hall.** Woodland/logistics and the activity pass have shipped. F26b1 now prototypes a substantial stone/timber venue against distributed squares using actual recreation visits. A nearby small outcrop versus a distant larger deposit creates the map decision; a visibly used hall supplies the payoff. Keep the F26b2 campaign scenario separate until human pacing feedback; the prototype can establish resource/service tradeoffs first. Start without a mandatory stonecutter or entertainer. F26c then tests mature woodland habitat against clearing and hunting pressure, with separate, recoverable consequences. See the [concrete scenario briefs and broader building candidates](CAMPAIGN_SYSTEMS.md#next-design-decisions-make-each-addition-earn-its-place).
