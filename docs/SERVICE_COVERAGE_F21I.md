...
F26c wildlife was the next independent prototype and is now implemented (see [its review](WILDLIFE_F26C.md)); F21j direct resource survey follows. Its design question remains: retained mature woodland should have a food value that competes with expansion and logging. Keep the resource experiment separate from The living woods scenario. F23a aesthetic acceptance and river/lake human pacing remain open; neither is inferred from this UI work. Keep comfort, learning and reflection tentative, seasons removed, and broader neighborhood food services in F07c. No new need meter or additional management dashboard is warranted by this chunk.
