...
3. **Village on both banks:** expand to at least sixteen residents, house everyone, provide eight east-bank beds and a completed east-bank square. At least half the current population must have their latest completed recreation visit at an east-bank Square within the last 120 simulation seconds. Each resident counts once; visits expire and a later break elsewhere replaces the qualifying visit. Seating Gardens and Gathering Halls do not count. Goals names the required venue and explains the moving window, automatic visits, and placement guidance. Begin the final assessment explicitly; housing and recreation must remain valid at each assessed meal.
