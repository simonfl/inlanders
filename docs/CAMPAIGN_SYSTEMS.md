...
4. F26a has implemented fishing and the seventh campaign, including actual meals, habitat sharing and boat recall. Near-dock/garden and far-dock/bread routes complete in seven/nine scripted simulation minutes; the near landing has the stronger measured logistics. Before adding more resources, F11b2 should improve campaign decisions and difficulty using those findings. The lake is currently a resource introduction, not the intended longer mastery experience. See [F26a measurements](FISHERY_F26A.md).
