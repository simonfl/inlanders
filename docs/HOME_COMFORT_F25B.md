...
F25b1 implementation brief. **Not implemented or balanced yet.** The next chunk is a working prototype and comparison; final building art and campaign use still follow their open reviews.
