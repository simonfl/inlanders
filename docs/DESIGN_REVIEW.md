...
The next implementation recommendation is **F23a, the three-building visual slice**, after the bounded save fix. Prices and further systems remain planned experiments. Keep all buildings available during campaign revision for now; progressive unlocking remains a later option. Seasons stay removed.
