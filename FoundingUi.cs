...
public partial class Game
{
    ...
    private void UpdateFoundingUi()
    {
        ...
        if(_world.PublicPlace is {} place){_goalTitle.Text=f.Finished?"A place to keep":place.Title+(place.Relaxed?" · relaxed":"");_objective.Text=f.Finished?"Finished for now. Watch the place, keep shaping, or leave and return later.":f.PlayerFounded?"Choose ground for homes and a livelihood. Provisions give you time to try.\nMore neighbors and finishing are optional.":"Keep what you like; choose what you want to change.\nMore neighbors and finishing are optional.";}
