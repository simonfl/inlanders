...
public partial class Game
{
    ...
    private void MakeContextualInspector()
    {
        ...
        var primary=new Node[]{_siteInfo,_productionControls,_workplaceControls,_welcomeControls,_moveButton,_restoreTrialSite,_cancelButton,_constructionPause,_priorityButtons[0].GetParent()};
