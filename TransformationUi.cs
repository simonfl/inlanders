...
public partial class Game
{
    ...
    private void HamletMenu(bool cultivatedBank)
    {
        ...
        _mainColumn.AddChild(Text(cultivatedBank?"Homes share two working fields and a kitchen garden. Four planks can furnish one home. Keep what you like; change what you want.":"A compact hamlet with kitchen gardens. Four planks can furnish one home. Keep what you like; change what you want.",16,true));
        ...
        MenuButton("About this place",()=>{
            ...
            _mainColumn.AddChild(Text("Both openings have twelve residents, twelve logs, four planks and72 starting food. The bank has36 cultivated tiles/48 vegetables per full crop; the compact village has18 tiles/24 vegetables. More land brings larger crops and more collection work. The woodlot is preserved; release chosen trees when you need timber. The meadow beyond the inlet has growing room. A crossing shortens journeys but grows no food.",16,true));
