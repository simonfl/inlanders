...
public partial class Game
{
    private void UpdateShorelineGoals()
    {
        ...
        _visitorPanel.Hide();
        _goalTitle.Text="Willow inlet · make it your village";
        _goalArrival.Text="Eight neighbors want to join. Homes cluster west; working gardens are across the inlet. Follow the footway, or change how village life fits together. Shared workers take available jobs.";
        ...
        _menuButtons[2].Text="Goals · Willow inlet";
