...
public partial class Game : Node3D
{
    ...
    private void RebuildLandscape()
    {
        ...
        _commonsVisualWorld=null;_workedWorld=null;_nextWorkedLand=0;
    ...
    private Node3D MakeTree(Vector3 at, float scale, Color leaves)
    {
        ...
        if(_storybookScene || _world.Founding?.TransformationHamlet==true){StorybookCrown(crown,at);return tree;}
