...
public partial class Game
{
    ...
    private void MakeExpandedLandscape()
    {
        ...
        if (_terrainRenderMap!=null || _world.Map.Heights.Length > 0 || _world.Map.RiverMeadow || _smoothGround) MakeTerrainSurface();
    ...
    private string CurrentSavePath => _world.Founding!=null?(_world.Founding.TransformationHamlet?TransformationPath:_world.Founding.WorkingVillage?WorkingVillagePath:_world.Founding.RiverFarmstead?RiverFarmsteadPath:FoundingPath):_world.CourtStudy is {} study?CourtStudyPath(study.Finite):_world.Creative && _world.IsArrangementCourt?CreativeCourtPath:_world.Neighborhood!=null?_neighborhoodPath:SandboxSavePath(_world.Map.Name == "Three clearings", _world.Creative);
