...
public partial class Game
{
    ...
    private string CurrentSavePath => _world.Founding!=null?(_world.Founding.RiverFarmstead?RiverFarmsteadPath:FoundingPath):_world.CourtStudy is {} study?CourtStudyPath(study.Finite):_world.Creative && _world.IsArrangementCourt?CreativeCourtPath:_world.Neighborhood!=null?_neighborhoodPath:SandboxSavePath(_world.Map.Name == "Three clearings", _world.Creative);
